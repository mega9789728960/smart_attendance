...
export default function EmployeePunchPage() {
  ...
  async function startPunch(action: PunchAction) {
    ...
    setLoading(true);
    setStatus("📍 Gathering telemetry and verifying location (this takes 3s)...");
    ...
    try {
      ...
      setStatus("✅ Location & Telemetry verified. Please verify your face");
      setShowFace(true);
      setLoading(false);
    } catch (err: any) {
  ...
  return (
    <div className="pb-4">
      <div className="max-w-lg mx-auto space-y-6">
        {/* Header */}
        <div className="rounded-2xl bg-gradient-to-r from-[var(--primary)] to-[var(--primary-hover)] p-7 shadow-lg text-white relative overflow-hidden">
